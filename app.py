...
import streamlit as st  # to create ui
import google.generativeai as genai
from langchain_community.vectorstores import FAISS # to create vector store
from langchain_google_genai import GoogleGenerativeAIEmbeddings # model to convert text to vector
